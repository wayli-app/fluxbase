...
-- Grant table and sequence permissions to RLS test user
...
GRANT ALL ON ALL TABLES IN SCHEMA public TO fluxbase_rls_test;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO fluxbase_rls_test;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO fluxbase_rls_test;
...
-- Set default privileges for postgres role (test setup creates tables as postgres)
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA auth GRANT ALL ON TABLES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA auth GRANT ALL ON SEQUENCES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON TABLES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON SEQUENCES TO fluxbase_rls_test;

-- Set default privileges for fluxbase_app role (migrations create tables as fluxbase_app)
ALTER DEFAULT PRIVILEGES FOR ROLE fluxbase_app IN SCHEMA auth GRANT ALL ON TABLES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE fluxbase_app IN SCHEMA auth GRANT ALL ON SEQUENCES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE fluxbase_app IN SCHEMA public GRANT ALL ON TABLES TO fluxbase_rls_test;
ALTER DEFAULT PRIVILEGES FOR ROLE fluxbase_app IN SCHEMA public GRANT ALL ON SEQUENCES TO fluxbase_rls_test;
