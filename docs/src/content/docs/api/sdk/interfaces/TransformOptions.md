...
| ------ | ------ | ------ |
| `fit?` | [`ImageFitMode`](/api/sdk/type-aliases/imagefitmode/) | How to fit the image within target dimensions (default: cover) |
| `format?` | [`ImageFormat`](/api/sdk/type-aliases/imageformat/) | Output format (defaults to original format) |
