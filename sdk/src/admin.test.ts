  ...
  describe('Admin Authentication', () => {
    describe('getSetupStatus()', () => {
      it('should check setup status', async () => {
        ...
        expect(mockFetch.get).toHaveBeenCalledWith('/api/v1/admin/setup/status')
    ...
    describe('logout()', () => {
      it('should logout admin user', async () => {
        ...
        vi.mocked(mockFetch.post).mockResolvedValue({ message: 'Logged out successfully' })
  ...
  describe('User Management', () => {
    ...
    describe('inviteUser()', () => {
      it('should invite a new user', async () => {
        ...
        expect(mockFetch.post).toHaveBeenCalledWith('/api/v1/admin/users/invite?type=app', {
          email: 'newuser@example.com',
          role: 'user',
          send_email: true,
        })
      ...
      it('should invite dashboard user', async () => {
        ...
        expect(mockFetch.post).toHaveBeenCalledWith('/api/v1/admin/users/invite?type=dashboard', {
          email: 'dashboarduser@example.com',
          role: 'dashboard_user',
        })
      })
    ...
    describe('deleteUser()', () => {
      it('should delete a user', async () => {
        ...
        expect(mockFetch.delete).toHaveBeenCalledWith('/api/v1/admin/users/user-123?type=app')
    ...
    describe('updateUserRole()', () => {
      it('should update user role', async () => {
        ...
        expect(mockFetch.patch).toHaveBeenCalledWith('/api/v1/admin/users/user-123/role?type=app', {
          role: 'admin',
        })
