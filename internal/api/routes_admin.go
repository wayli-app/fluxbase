...
func (s *Server) buildAdminRouteDeps() *routes.AdminDeps {
	...
	return &routes.AdminDeps{
		...
		Schema: &routes.SchemaAdminDeps{
			GetTables:               s.Schema.Admin.GetTables,
			GetTableSchema:          s.Schema.Admin.GetTableSchema,
			GetSchemas:              s.Schema.Admin.GetSchemas,
			ExecuteQuery:            s.Schema.Admin.ExecuteQuery,
			...
			RefreshSchema:           s.Schema.Admin.RefreshSchema,
			GetSchemaGraph:          s.Schema.Graph.GetSchemaGraph,
			GetTableRelationships:   s.Schema.Graph.GetTableRelationships,
			GetTablesWithRLS:        s.Schema.Policy.GetTablesWithRLS,
			GetTableRLSStatus:       s.Schema.Policy.GetTableRLSStatus,
			ToggleTableRLS:          s.Schema.Policy.ToggleTableRLS,
			ListPolicies:            s.Schema.Policy.ListPolicies,
			CreatePolicy:            s.Schema.Policy.CreatePolicy,
			UpdatePolicy:            s.Schema.Policy.UpdatePolicy,
			DeletePolicy:            s.Schema.Policy.DeletePolicy,
			GetPolicyTemplates:      s.Schema.Policy.GetPolicyTemplates,
			GetSecurityWarnings:     s.Schema.Policy.GetSecurityWarnings,
