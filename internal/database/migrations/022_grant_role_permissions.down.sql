...
REVOKE ALL ON ALL TABLES IN SCHEMA _fluxbase FROM anon, authenticated, service_role;
REVOKE ALL ON ALL SEQUENCES IN SCHEMA _fluxbase FROM anon, authenticated, service_role;
