...
class FluxbaseClient internal constructor(
    ...
    fun channel(
        ...
        val wsTransport = transport ?: io.github.nimbleflux.fluxbase.realtime.KtorWebSocketTransport(trustAllCertificates = trustSslCertificates)
    ...
    companion object {
        ...
        fun create(
            ...
            val resolvedTransport = transport ?: KtorHttpTransport(resolvedUrl, timeoutMillis = options.timeout, trustAllCertificates = options.trustSslCertificates)
